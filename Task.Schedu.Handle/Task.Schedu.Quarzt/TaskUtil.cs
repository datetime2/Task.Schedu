...
namespace Task.Schedu.Quarzt
{
    ...
    public class TaskHelper
    {
        ...
        {
            return SQLHelper.Single<TaskUtil>("SELECT * FROM t_Tasks WHERE TaskID=@TaskID", new { TaskID = TaskID });
        }
        ...
        public static void DeleteById(string TaskID)
        {
            ...
            SQLHelper.ExecuteNonQuery("DELETE FROM t_Tasks WHERE TaskID=@TaskID", new { TaskID = TaskID });
        }
        ...
        public static void UpdateTaskStatus(string TaskID, TaskStatus Status)
        {
            ...
            SQLHelper.ExecuteNonQuery("UPDATE t_Tasks SET Status=@Status WHERE TaskID=@TaskID", new { TaskID = TaskID, Status = Status });
        }
        ...
        {
            SQLHelper.ExecuteNonQuery("UPDATE t_Tasks SET LastRunTime=@LastRunTime WHERE TaskID=@TaskID", new { TaskID = TaskID, LastRunTime = LastRunTime });
        }
        ...
        {
            SQLHelper.ExecuteNonQuery("UPDATE t_Tasks SET RecentRunTime=@RecentRunTime,LastRunTime=@LastRunTime WHERE TaskID=@TaskID", new { TaskID = TaskID, LastRunTime = LastRunTime, RecentRunTime = DateTime.Now });
        }
        ...
        {
            return SQLHelper.ToList<TaskUtil>("SELECT * FROM t_Tasks where Status=0");
        }
